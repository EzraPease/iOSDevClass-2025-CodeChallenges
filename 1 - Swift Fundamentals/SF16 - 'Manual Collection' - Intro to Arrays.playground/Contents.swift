...
//  Instructions:
    ...
    //  The towing company has relaxed their rules and now, not every car in the parking gets towed immediately. Add two more functions, giveTicket(parkingSpace: Int) and collectFee(parkingSpace: Int).
        ...
        //  `collectFee()` should charge the car's owner $1 for each character in the string for their parking space. Add to cashCollected property
...
// I'm never ever ever ever doing this instead of a collection again
