...
func triangleArea(a: Double, b: Double, c: Double) -> String {
    
    let calculateS = (a + b + c) / 2.0
    let area = sqrt(calculateS * (calculateS - a) * (calculateS - b) * (calculateS - c))
...
func validTriangle(a: Double, b: Double, c: Double) -> Bool {
    return (a + b) > c && (a + c) > b && (b + c) > a
}

print(triangleArea(a: -4, b: 13, c: 15))
